...
function SidebarControl({ open, label, onChange, disabled }: SidebarControlProps): JSX.Element {
  ...
  return (
    <div className={clsx('relative')}>
      <button
        className={clsx(
          'z-10 flex w-full flex-grow items-center justify-between rounded-full border border-gray-800 bg-gray-800 py-3 px-4 text-white transition hover:border-white',
