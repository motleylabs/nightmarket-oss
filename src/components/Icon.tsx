    ...
    <svg className={className} viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_1084_6329)">
        <path
          ...
          fill={noGradient ? '#A8A8A8' : 'url(#paint0_linear_1084_6329)'}
        ></path>
        <path
          ...
          fill={noGradient ? '#A8A8A8' : 'url(#paint1_linear_1084_6329)'}
        ></path>
        <path
          ...
          fill={noGradient ? '#A8A8A8' : 'url(#paint2_linear_1084_6329)'}
        ></path>
      </g>
      <defs>
        <linearGradient
