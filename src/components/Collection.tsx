...
function CollectionOption({
  ...
  return (
    <div
      className={clsx(
        'mb-2 flex cursor-pointer rounded-lg border border-gray-800 p-2 transition hover:scale-[1.02]',
...
function CollectionOptionSkeleton({
  ...
  return (
    <div
      className={clsx(
        'over flex animate-pulse rounded-lg border border-gray-800 p-2 transition',
        className
      )}
    >
      <div className="aspect-square h-16 w-16 rounded-lg bg-gray-800" />
...
export default function CollectionCard({ collection }: CollectionCardProps): JSX.Element {
  ...
  return (
    <div className="relative flex aspect-square w-full flex-col justify-end overflow-hidden rounded-lg shadow-lg transition hover:scale-[1.02]">
      <img
