...
export function Offerable({ children, variant = 'viewer' }: OfferableProps) {
        ...
        return (
          <>
            ...
            <section id={'offer-buttons'} className="flex flex-col gap-4">
              <Button block htmlType="submit" loading={offerFormState.isSubmitting}>
                {t('offer')}
              </Button>
              <Button
                block
  ...
  return (
    <div>
      ...
      <Modal title={'Make an offer'} open={open} setOpen={setOpen}>
          ...
          {loading ? (
            <>
              ...
              <section id={'loading-buttons'} className="flex flex-col gap-4">
                ...
                <Button loading={true} type={ButtonType.Secondary}></Button>
              </section>
            </>
          ) : (
            <Form
