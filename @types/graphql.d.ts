...
export const NftDetailsQuery: DocumentNode;
...
declare module '*/report.graphql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
  export const ReportQuery: DocumentNode;
...
declare module '*/solananetwork.graphql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
  export const SolanaNetworkQuery: DocumentNode;
